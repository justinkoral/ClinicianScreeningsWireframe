...
I started by using the  numbers that drive decisions screened patients, eligible patients, rates, etc. Then I built a  visual hierarchy, where KPIs sit right at the top for an instant status check, followed by a table of a provider leaderboards that give deeper context, and then a clustered vertical bar chart (or line chart) by month at the bottom. 
